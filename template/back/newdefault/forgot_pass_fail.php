	...
	<div class="slider">
		<div id="breadcrumb">
			<div class="container_24">
			  <div class="grid_24">
			  	<h2><a href="<?php echo base_url();?>site/member">Website</a></h2><em class="separator"></em><h2><a href="<?php echo base_url();?>">Reset Password</a></h2>
		...
		<div class="content admnewkaffah">
			...
			<div class="blog_left menuadmin_left">		
				<div class="blog_main single">	
					...
					<p class="headnote">Silahkan ulangi...</p>					
				 </div>
