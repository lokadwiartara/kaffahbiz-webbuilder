...
<h1 class="headnote"><a href="../../#article" class="headbread">Artikel</a><em class="separator"></em><font>Pengeditan</font></h1>
<!-- this is not displayed -->

<script type="text/javascript" src="<?php echo get_asset('js');?>ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/edit_article.js"></script>
...
<a href="/site/admin/1/full/#save" class="orangebutton" id="addblogyes">Update Artikel Ini!</a>
<h2 class="headnote full">Pengeditan Artikel</h2>
...
<div class="newarticle">
	...
	<div id="settingbar">
		...
		<h3 class="timepubset headwrap">Waktu Tayang</h3>
