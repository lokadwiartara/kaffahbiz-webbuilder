...
<html>
<head>
<title>KaffahBiz Admin | Lupa Password?</title>
	...
	<div class="slider">
		<div id="breadcrumb">
			<div class="container_24">
			  <div class="grid_24">
			  	<h2><a href="<?php echo base_url();?>site/member">Website</a></h2><em class="separator"></em><h2><a href="<?php echo base_url();?>">Lupa Password</a></h2>
		...
		<div class="content admnewkaffah">
			...
			<div class="blog_left menuadmin_left">		
				<div class="blog_main single">	
					<h2>Lupa Password?</h2>
					<p class="headnote">Silahkan masukkan email Anda, kami akan mengirim password baru ke email Anda</p>
					<div class="form login">
						<?php echo get_form_error('error_msg');?>
						<form action="<?php echo base_url();?>forgot_pass" id="forgotpass" method="POST">
							<label for="email" class="form">Email</label><input value="<?php echo set_value('email');?>" class="textlong" type="text" name="email" id="email" /><?php echo form_error('email');?>							
							<input type="submit" name="reset" value="Reset Password Sekarang!" class="bluesubmit" />
						</form>
