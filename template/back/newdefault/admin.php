...
<?php $domain_reseller = get_domain_atr('domain_reseller');?>
<div class="blackbg">
			...
			<div class="blog_sidebar menusidebarblog">
				<div class="sidebar menuside">
					...
					<div class="coremenuwrap">
						...
						<?php if($domain_reseller): ?>
							<h4 class="btnhead">Menu Reseller</h4>
							<ul class="coremenu">
								<li class="resellerproduct"><a href="full/#reseller_product" class=" topa">Produk Supplier</a></li>
								<li class="order"><a href="#order_reseller" class="topa">Pemesanan</a></li>
								<li class="money24"><a href="#commision" class="topa">Komisi</a></li>
							</ul>
						<?php endif; ?>
