...
<h1 class="headnote"><a href="../#page" class="headbread">Halaman</a><em class="separator"></em><font>Tambah Baru</font></h1>

<script type="text/javascript" src="<?php echo get_asset('js');?>ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/new_page.js"></script>
...
<a href="/site/admin/31/#page" class="greybutton pagebtn" id="tutupblog">Tutup [x]</a>
<a href="/site/admin/1/full/#save" class="greybutton pagebtn" id="simpanblog">Jadikan Draft</a>
<a href="/site/admin/1/full/#save" class="orangebutton pagebtn" id="addblogyes">Publish Halaman</a>

<h2 class="headnote full">Tambah Halaman Baru</h2>

<!--<input type="submit" onclick="tes()" />-->

<div class="newarticle">
	<input type="text" name="titlearticle" class="longfull" autocomplete="off" value="Tuliskan judul halaman di sini ..." onFocus="if(this.value=='Tuliskan judul halaman di sini ...')this.value=''" onBlur="if(this.value=='')this.value='Tuliskan judul halaman di sini ...'" />
	...
	<textarea name="editor1" id="editor1" rows="100">Masukkan isi halaman di sini ...</textarea>
