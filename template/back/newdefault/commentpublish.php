...
<h1 class="headnote"><a href="#comment" class="headbread">Komentar</a><em class="separator"></em><font>Terpasang</font></h1>
<!-- this is not displayed -->

<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/publish_comment.js"></script>
...
<h2 class="headnote">Daftar Komentar Terpasang</h2>
<br />
<br />
