...
<h1 class="headnote"><a href="#article" class="headbread">Artikel</a><em class="separator"></em><font>Diterbitkan</font></h1>
<!-- this is not displayed -->

<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/publish_article.js"></script>
...
<p class="headnote">Ini adalah daftar semua artikel yang <b>sudah Diterbitkan</b></p>
<br />
<br />
