...
<h1 class="headnote"><a href="#article" class="headbread">Artikel</a><em class="separator"></em><font>Kategori Artikel</font></h1>
<div class="wraphide">
	...
	<form id="formaddcat" method="POST">
		...
		<p class="notes catnotes">Silahkan masukkan judul kategori, contoh: <b>Politik</b></p>
...
<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/cat_article.js"></script>

<a class="orangebutton" id="addcat">+ Buat Kategori Baru</a>
<h2 class="headnote">Kategori Artikel</h2>
