...
<h1 class="headnote"><a href="../../#product" class="headbread">Produk</a><em class="separator"></em><font>Pengeditan</font></h1>
<!-- this is not displayed -->
...
<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/edit_product.js"></script>
...
<a href="/site/admin/1/full/#save" class="greybutton prodbtn" id="simpanblog">Simpan Sebagai Draft</a>

<a href="/site/admin/1/full/#save" class="orangebutton prodbtn" id="addblogyes">Update Produk Ini!</a>
<h2 class="headnote full">Pengeditan Produk</h2>
<!--<input type="submit" onclick="tes()" />-->

<div class="newarticle">
	<input type="text" id="titlearticle" name="titlearticle" class="longfull" autocomplete="off" value="Tuliskan judul Artikelnya di sini ..." onFocus="if(this.value=='Tuliskan judul Artikelnya di sini ...')this.value=''" onBlur="if(this.value=='')this.value='Tuliskan judul Artikelnya di sini ...'" />
	...
	<div id="settingbar">
		...
		<div class="timepubset wraptop">
			...
			<div class="wrappset timewrap"> <em>Tanggal : dd/mm/yyyy</em>
				<input type="text" name="date" value="" class="timewrapshort" /> / 
				...
				<input type="text" name="year" class="timewrapshort" value="" />
				<em class="time">Pukul : hh:mm </em>
				<input type="text" name="hour" value="" class="timewrapshort" /> : 
				<input type="text" name="minute" value="" class="timewrapshort" />
		...
		<div class="productset wraptop">
			<div class="wrappset writer">
				<div class="productdetail">
					...
					<form method="POST" id="formuploadfileproductedit" action="/reqpost/upload" enctype="multipart/form-data">
						<input id="massuploadedit" type="file" name="userfile" />
					</form>

					<!--<a href="" class="btnuploadimg">Upload Gambar!</a>--><br />
					<p class="note full">upload gambar/photo produk Anda dengan mengklik <b>tombol diatas!</b> (upload gambar bisa lebih dari satu)</p>

					<div class="info_product">
						<br /><br /><h3 class="note price">Harga dan Ketersediaan</h3><br />
						<label>Kode Produk</label><input type="text" class="singleinput" name="product_code" id="product_code" /><br />
						...
						<label>Harga (Rp)</label><input type="text" class="singleinput" name="product_price" id="product_price" /><br />
						<p class="notehalf">contoh penulisan harga produk (contoh penulisan : <b>331.924</b>)</p><br />
						<label>Stok Barang</label><input type="text" class="singleinput" name="product_stock" id="product_stock" /><br />
					...
					<div class="leftdetailproduct">
						...
						<label>Berat/Bobot</label><input type="text" name="berat" id="berat" class="sort" />
						<select name="satuanberat" id="satuanberat" ><option value="gram">gram</option></select><br />
						<label>Tinggi</label><input type="text" name="tinggi" id="tinggi" class="sort" />
						<select name="satuantinggi" id="satuantinggi"><option value="cm">cm</option></select><br />
						<label>Lebar</label><input type="text" id="lebar" name="lebar" class="sort" />
						<select name="satuanlebar" id="satuanlebar"><option value="cm">cm</option></select><br />
						<label>Panjang</label><input type="text" name="panjang" class="sort" id="panjang" />
						<select name="satuanpanjang" id="satuanpanjang"><option value="cm">cm</option></select><br />
					...
					<div class="rightdetailproduct">
						...
						<label>Warna</label><input type="text" id="product_colour" name="product_colour" /><br />
						<p class="notehalf">masukkan warnanya, dipisahkan dengan koma<br />contoh: <b>kuning,hijau,merah</b></p><br />
						<label>Ukuran</label><input type="text" id="product_size" name="product_size" />
