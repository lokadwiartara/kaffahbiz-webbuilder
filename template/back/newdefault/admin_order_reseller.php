...
<h1 class="headnote"><a href="../#product" class="headbread">Produk</a><em class="separator"></em><font>Transaksi Reseller</font></h1>

<!-- this is not displayed -->
<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/admin_order_reseller.js"></script>

<h2 class="headnote">Daftar Transaksi Reseller</h2>
...
<div id="tablepost">
	...
	<table class="post" id="orderlist">
		<thead>
			<tr><th width="2%" class="check"></th><th width="5%" class="invoice">Invoice</th><th width="15%" class="reseller">Reseller</th><th width="20%" class="nama">Nama Konsumen</th><th width="20%">Alamat</th><th width="20%" class="trx">Transaksi</th><th width="20%">Total</th><th>Status</th></tr>
		</thead>
		<tbody>
