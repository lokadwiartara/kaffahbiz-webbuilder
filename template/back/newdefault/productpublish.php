...
<h1 class="headnote"><a href="#product" class="headbread">Produk</a><em class="separator"></em><font>Diterbitkan</font></h1>
<!-- this is not displayed -->

<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/publish_product.js"></script>
...
<p class="headnote">Ini adalah daftar semua produk yang <b>sudah Diterbitkan</b></p>
<br />
<br />
