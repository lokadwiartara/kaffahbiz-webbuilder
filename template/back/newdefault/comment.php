...
<h1 class="headnote"><a href="#comment" class="headbread">Komentar</a><em class="separator"></em><font>Semua</font></h1>
<!-- this is not displayed -->

<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/normal_comment.js"></script>
...
<h2 class="headnote">Daftar Komentar</h2>
<br />
<br />
