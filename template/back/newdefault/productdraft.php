...
<h1 class="headnote"><a href="#product" class="headbread">Produk</a><em class="separator"></em><font>Draft</font></h1>
<!-- this is not displayed -->


<script type="text/javascript" src="<?php echo get_dir_(dirname(__FILE__), 'js');?>/draft_product.js"></script>
...
<p class="headnote">Ini adalah daftar semua produk masih dalam <b class="red">status Draft</b></p>
